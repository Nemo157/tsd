...
(function (xm) {
    ...
    (function (_object) {
        ...
        function lockProps(object, props, pub, pref) {
            if (pub === void 0) { pub = true; }
            if (pref === void 0) { pref = true; }
            props.forEach(function (property) {
                if (/^_/.test(property)) {
                    if (pref) {
...
(function (xm) {
    ...
    (function (_file) {
        ...
        function mkdirCheckSync(dir, writable, testWritable) {
            ...
            if (testWritable === void 0) { testWritable = false; }
...
(function (xm) {
    ...
    var JSONStabilizerMap = (function () {
        ...
        JSONStabilizerMap.prototype.associate = function (object, snapshotNow) {
            if (snapshotNow === void 0) { snapshotNow = true; }
            var stable;
...
(function (git) {
    ...
    })(GitUtil = git.GitUtil || (git.GitUtil = {}));
})(git || (git = {}));
var tsd;
(function (tsd) {
    'use strict';
...
(function (tsd) {
    ...
    var ContentLoader = (function (_super) {
        ...
        ContentLoader.prototype.loadContent = function (file, tryHead) {
            var _this = this;
            if (tryHead === void 0) { tryHead = false; }
            if (file.hasContent()) {
    ...
    var API = (function () {
        ...
        API.prototype.saveBundles = function (files, options) {
            ...
            Q.all(bundles.map(function (target) {
                ...
                if ((options.saveToConfig || options.saveBundle) && _this.context.config.bundle) {
